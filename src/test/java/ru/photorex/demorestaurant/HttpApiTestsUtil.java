...
public class HttpApiTestsUtil {
    ...
    public static String getAllDishes() {
        return "{\n" +
                ...
                "                \"_links\": {\n" +
                "                    \"self\": {\n" +
                "                        \"href\": \"http://localhost:8080/api/dishes/10\"\n" +
                "                    }\n" +
                "                }\n" +
                "            },\n" +
                "            {\n" +
                ...
                "                \"_links\": {\n" +
                "                    \"self\": {\n" +
                "                        \"href\": \"http://localhost:8080/api/dishes/11\"\n" +
                "                    }\n" +
                "                }\n" +
                "            },\n" +
                "            {\n" +
                ...
                "                \"_links\": {\n" +
                "                    \"self\": {\n" +
                "                        \"href\": \"http://localhost:8080/api/dishes/12\"\n" +
                "                    }\n" +
                "                }\n" +
                "            },\n" +
                "            {\n" +
                ...
                "                \"_links\": {\n" +
                "                    \"self\": {\n" +
                "                        \"href\": \"http://localhost:8080/api/dishes/13\"\n" +
                "                    }\n" +
                "                }\n" +
                "            },\n" +
                "            {\n" +
                ...
                "                \"_links\": {\n" +
                "                    \"self\": {\n" +
                "                        \"href\": \"http://localhost:8080/api/dishes/14\"\n" +
                "                    }\n" +
                "                }\n" +
                "            },\n" +
                "            {\n" +
                ...
                "                \"_links\": {\n" +
                "                    \"self\": {\n" +
                "                        \"href\": \"http://localhost:8080/api/dishes/15\"\n" +
                "                    }\n" +
                "                }\n" +
                "            },\n" +
                "            {\n" +
                ...
                "                \"_links\": {\n" +
                "                    \"self\": {\n" +
                "                        \"href\": \"http://localhost:8080/api/dishes/16\"\n" +
                "                    }\n" +
                "                }\n" +
                "            },\n" +
                "            {\n" +
                ...
                "                \"_links\": {\n" +
                "                    \"self\": {\n" +
                "                        \"href\": \"http://localhost:8080/api/dishes/17\"\n" +
                "                    }\n" +
                "                }\n" +
                "            },\n" +
                "            {\n" +
                ...
                "                \"_links\": {\n" +
                "                    \"self\": {\n" +
                "                        \"href\": \"http://localhost:8080/api/dishes/18\"\n" +
                "                    }\n" +
                "                }\n" +
                "            },\n" +
                "            {\n" +
                ...
                "                \"_links\": {\n" +
                "                    \"self\": {\n" +
                "                        \"href\": \"http://localhost:8080/api/dishes/19\"\n" +
                "                    }\n" +
                "                }\n" +
                "            },\n" +
                "            {\n" +
                ...
                "                \"_links\": {\n" +
                "                    \"self\": {\n" +
                "                        \"href\": \"http://localhost:8080/api/dishes/20\"\n" +
                "                    }\n" +
                "                }\n" +
                "            }\n" +
                "        ]\n" +
                ...
                "    \"_links\": {\n" +
                "        \"first\": {\n" +
                "            \"href\": \"http://localhost:8080/api/dishes?page=0&size=20\"\n" +
                "        },\n" +
                "        \"self\": {\n" +
                "            \"href\": \"http://localhost:8080/api/dishes?page=0&size=20\"\n" +
                "        },\n" +
                "        \"next\": {\n" +
                "            \"href\": \"http://localhost:8080/api/dishes?page=1&size=20\"\n" +
                "        },\n" +
                "        \"last\": {\n" +
                "            \"href\": \"http://localhost:8080/api/dishes?page=1&size=20\"\n" +
                "        },\n" +
                "        \"add\": {\n" +
                "            \"href\": \"http://localhost:8080/api/dishes/{restaurantId}\",\n" +
                "            \"templated\": true\n" +
                "        },\n" +
                "        \"delete\": {\n" +
                "            \"href\": \"http://localhost:8080/api/dishes/{id}\",\n" +
                "            \"templated\": true\n" +
                "        },\n" +
                "        \"update\": {\n" +
                "            \"href\": \"http://localhost:8080/api/dishes/{id}\",\n" +
